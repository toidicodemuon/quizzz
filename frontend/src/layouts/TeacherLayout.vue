  ...
  <div class="drawer lg:drawer-open min-h-screen">
    ...
    <div class="drawer-side">
      ...
      <aside class="menu p-4 w-72 bg-base-200 min-h-full">
        ...
        <RouterLink class="menu-item btn btn-ghost justify-start w-full" to="/teacher/dashboard">{{ $t('nav.dashboard') }}</RouterLink>
        <RouterLink class="menu-item btn btn-ghost justify-start w-full" to="/teacher/quizzes">{{ $t('nav.quizzes') }}</RouterLink>
        <RouterLink class="menu-item btn btn-ghost justify-start w-full" to="/teacher/submissions">{{ $t('nav.submissions') }}</RouterLink>
      </aside>
    </div>
  </div>
