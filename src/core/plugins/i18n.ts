...
const messages = {
  ...
  vi: {
    ...
    layoutBuilder: "Trình xây dựng bố cục",
    craft: "Tùy chỉnh",
    pages: "Trang",
    profile: "Hồ sơ",
    ...
    multiStepSignUp: "Đăng ký nhiều bước",
    error404: "Lỗi 404",
    error500: "Lỗi 500",
    apps: "Ứng dụng",
    chat: "Trò chuyện",
    privateChat: "Trò chuyện riêng tư",
    groupChat: "Trò chuyện nhóm",
    drawerChat: "Chat dạng ngăn kéo",
    widgets: "Tiện ích",
    widgetsLists: "Danh sách",
    widgetsStatistics: "Thống kê",
    widgetsCharts: "Biểu đồ",
    widgetsMixed: "Hỗn hợp",
    widgetsTables: "Bảng",
    widgetsFeeds: "Nguồn cấp",
    changelog: "Nhật ký thay đổi",
    docsAndComponents: "Tài liệu & Thành phần",
    megaMenu: "Menu lớn",
    exampleLink: "Liên kết mẫu",
    modals: "Hộp thoại",
    general: "Chung",
    inviteFriends: "Mời bạn bè",
    viewUsers: "Xem người dùng",
    upgradePlan: "Nâng cấp gói",
    shareAndEarn: "Chia sẻ & nhận thưởng",
    forms: "Biểu mẫu",
