  ...
  <div class="drawer lg:drawer-open min-h-screen">
    ...
    <div class="drawer-side">
      ...
      <aside class="menu p-4 w-72 bg-base-200 min-h-full">
        <div class="text-xl font-bold mb-4">Student</div>
        <RouterLink class="menu-item btn btn-ghost justify-start w-full" to="/student/dashboard">{{ $t('nav.dashboard') }}</RouterLink>
      </aside>
    </div>
  </div>
</template>
